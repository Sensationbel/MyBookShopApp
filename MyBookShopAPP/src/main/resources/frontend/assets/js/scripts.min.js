        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="/books/' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.discountPrice ? '<span class="Card-price">' + book.discountPrice + '</span>\n' : book.price) + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/books/author/page/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь не найден или не верный логин\/пароль!!!' + '</div>');
                                        }
                                    }
                                })
                            }
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recent/main')
                                                break;
                                            case'popular':
                                                sendData('/books/popular/main')
                                                break;
                                        }
                                    }
                                }
